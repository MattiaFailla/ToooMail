<template>
    <div class="page">
        <div id="error">
            <div id="box"></div>
            <h3>ERROR 500</h3>
            <p>Things are a little <span>messy</span> here</p>
            <p>I suggest to close and reopen the app</p>
        </div>
    </div>
</template>
...
<style scoped>
    ...
    .page div#error div#box:before,
    .page div#error div#box:after {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
    ...
    .page div#error h3:before,
    .page div#error h3:after {
        content: 'ERROR 500';
        position: absolute;
        top: -1px;
        left: 0;
    ...
    .page div#error p span:before,
    .page div#error p span:after {
        content: 'messy';
        position: absolute;
        top: -1px;
        left: 0;
